...
//    private  int Zcount = 0;
    ...
    String downloadUrl = "http://impact.asu.edu/CSE535Spring18Folder/Test_Group9.db";
...
//        onDestroy();
    ...
    public class UploadAsyncTask extends AsyncTask<Void,Void,Void> {
        ...
        protected Void doInBackground(Void... args) {
            ...
            File db = new File(dbFilePath+getPackageName()+"/Project_Group9");
            ...
            RequestBody requestBody = new MultipartBody.Builder()
                    ...
                    .addFormDataPart("uploaded_file","Test_Group9.db",file_body)
                    .build();
...
//                    Long reference = downloadManager.enqueue(request);
            ...
            if(file_found){
                ...
                try {
                    ...
                    output = new FileOutputStream("/sdcard/Android/data/"+getPackageName()+"/"+"/Project_Downloaded_Group-9.db");
        ...
        protected void onPostExecute(String args) {
            ...
            if(file_found){
                ...
                if(pointArray1.size() > 10) {
                    ...
                    for (int i = 0; i < pointArray1.size() - 1; i++) {
                        new_series1.appendData(pointArray1.get(i), true, 10);
                        new_series2.appendData(pointArray2.get(i), true, 10);
                        new_series3.appendData(pointArray3.get(i), true, 10);
                    }
