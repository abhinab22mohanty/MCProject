...
public class DatabaseHelper extends SQLiteOpenHelper{
    ...
    public static final String DATABASE_NAME = "Project_Group9";
    ...
    public static final String packageName = "group9.brainet.com.brainetproject";
    ...
    public SQLiteDatabase openDatabase() {
        File databaseFile = new File("/sdcard/Android/data/"+packageName, "Project_Downloaded_Group-9.db");
